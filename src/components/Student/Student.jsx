        ...
        <section className='student'>
            ...
            <div className='student__info'>
                <article className='student__info-text'>
                    ...
                    <p className='student__info-description'>Я родился и живу в Москве, закончил факультет авиационных систем и комплексов МГТУ ГА. Работаю в S7 Technics инженером. Недавно начал кодить. Изучаю программирование из любопытства</p>
